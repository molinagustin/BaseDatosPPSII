...
CREATE TABLE `puntos_venta` (
  `IdPuntoVta` int(11) NOT NULL AUTO_INCREMENT,
  `Punto_Venta` varchar(120) NOT NULL,
  `Num_Puppeteer` int(11) NOT NULL,
  PRIMARY KEY (`IdPuntoVta`)
...
INSERT INTO `puntos_venta` VALUES (1,'Direccion del lugar',99999);
